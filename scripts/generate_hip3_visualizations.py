...
4 GIFs + 2 PNGs in dark terminal aesthetic matching the original repo.
"""
import matplotlib
matplotlib.use('Agg')
import sys, warnings
...
def gen_heatmap(data):
    print('\n[5/6] hip3_vol_spread_heatmap.png ...')
...
def gen_summary(csv_path):
    print('\n[6/6] hip3_arbitrage_summary.png ...')
...
def main():
    ...
    gen_dashboard(data,all_bt); gen_iv(); gen_greeks(); gen_equity(curves); gen_heatmap(data)
